...
class MakerConfig:
    ...
    # Reference scale: 90% of the $100.0 default bankroll. The live run
    ...
    # Default reference scale is $100.0 (aligned with default bankroll_usd);
    # the live run overrides this via SPREAD_HUNTER_BANKROLL
